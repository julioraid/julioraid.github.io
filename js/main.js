...
(function($) {
	...
	$(document).ready( function() {
		...
		if( $('.map-canvas').length > 0) {
			...
			var address = 'Av. Armando de Andrade, 313, Tabo&atilde;o da Serra, SP, Brasil';
			var contentString = '<div class="map-detail"><strong>Escrit&oacute;rio:</strong><p>' + address + '</p></div>';
